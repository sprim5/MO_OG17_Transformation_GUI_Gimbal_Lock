...
%}
    ...
    % Rotation
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Window.RotationTab = uitab(Window.TransformationTabs ...
      , 'Title', 'Rotation' ...
    );

    Window.RotationInputChange = uicontrol(Window.RotationTab,...
          'Style', 'edit' ...
        , 'Position', [110 110 50 50] ...
        , 'FontSize', 10 ...
        , 'String', 10.0 ...
    );
    Window.RotationButtonMinusX = uicontrol(Window.RotationTab,...
          'Style', 'pushbutton' ...
        , 'String', '-X' ...
        , 'Position', [60 110 50 50] ...
        , 'FontSize', 20 ...
    ...
    Window.RotationButtonPlusX = uicontrol(Window.RotationTab,...
          'Style', 'pushbutton' ...
        , 'String', '+X' ...
        , 'Position', [160 110 50 50] ...
        , 'FontSize', 20 ...
    ...
    Window.RotationInputX = uicontrol(Window.RotationTab,...
          'Style', 'edit' ...
        , 'Position', [210 110 50 50] ...
        , 'FontSize', 10 ...
    ...
    Window.RotationButtonPlusY = uicontrol(Window.RotationTab,...
          'Style', 'pushbutton' ...
        , 'String', '+Y' ...
        , 'Position', [110 160 50 50] ...
        , 'FontSize', 20 ...
    ...
    Window.RotationButtonMinusY = uicontrol(Window.RotationTab,...
          'Style', 'pushbutton' ...
        , 'String', '-Y' ...
        , 'Position', [110 60 50 50] ...
        , 'FontSize', 20 ...
    ...
    Window.RotationInputY = uicontrol(Window.RotationTab,...
          'Style', 'edit' ...
        , 'Position', [110 210 50 50] ...
        , 'FontSize', 10 ...
        , 'Callback', @(Source, Event) setRotation() ...
    ...
    Window.RotationButtonMinusZ = uicontrol(Window.RotationTab,...
          'Style', 'pushbutton' ...
        , 'String', '-Z' ...
        , 'Position', [60 60 50 50] ...
        , 'FontSize', 20 ...
    ...
    Window.RotationButtonPlusZ = uicontrol(Window.RotationTab,...
          'Style', 'pushbutton' ...
        , 'String', '+Z' ...
        , 'Position', [160 160 50 50] ...
        , 'FontSize', 20 ...
    ...
    Window.RotationInputZ = uicontrol(Window.RotationTab,...
          'Style', 'edit' ...
        , 'Position', [210 210 50 50] ...
        , 'FontSize', 10 ...
        , 'Callback', @(Source, Event) setRotation() ...
