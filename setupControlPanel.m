function Panel = setupControlPanel(Parent, Application)
    ...
    TranslationX = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0');
    TranslationY = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0');
    TranslationZ = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0');
    ...
    ScalingX = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0');
    ScalingY = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0');
    ScalingZ = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0');
