function Panel = setupControlPanel(Parent, Application)
    ...
    row(TranslationTab, 50, TranslationDelta);
    row(TranslationTab ...
      , 50 ...
    ...
    row(ScalingTab, 50, ScalingDelta);
    row(ScalingTab ...
      , 50 ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', '-X', 'Callback', @(Source, Event) change('-x')) ...
      , ScalingX ...
    ...
    ShearingDelta = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '1.0');
    ShearingX = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0', 'Callback', @(Source, Event) setTransformation('x'));
    ShearingY = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0', 'Callback', @(Source, Event) setTransformation('y'));
    ShearingZ = uicontrol('Style', 'edit', 'FontSize', 10, 'String', '0.0', 'Callback', @(Source, Event) setTransformation('z'));

    row(ShearingTab, 50, ShearingDelta);
    row(ShearingTab ...
      , 50 ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', '-X', 'Callback', @(Source, Event) change('-x')) ...
      , ShearingX ...
    ...
    row(MirroringTab ...
      , 150 ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', 'XY Ebene', 'Callback', @(Source, Event) change('xy')) ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', 'X Achse', 'Callback', @(Source, Event) change('x')) ...
    );
    row(MirroringTab ...
      , 150 ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', 'XZ Ebene', 'Callback', @(Source, Event) change('xz')) ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', 'Y Achse', 'Callback', @(Source, Event) change('y')) ...
    );
    row(MirroringTab ...
      , 150 ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', 'YZ Ebene', 'Callback', @(Source, Event) change('yz')) ...
      , uicontrol('Style', 'pushbutton', 'FontSize', 20, 'String', 'Z Achse', 'Callback', @(Source, Event) change('z')) ...
    );
    
    
    set(TransformationTabs, 'TabTitles', { 'Translation', 'Scaling', 'Rotation', 'Shearing', 'Mirroring' });
    set(TransformationTabs, 'TabEnables', { 'off', 'off', 'off', 'off', 'off' });


    function Row = row(Parent, buttonSize, varargin)
        Row = uix.HButtonBox(...
            'Parent', Parent ...
          , 'Spacing', 5 ...
    ...
    function onUpdate(Args)
        ...
        if NumTransformations > 0
            TransformationTabs.TabEnables = { 'on', 'on', 'on', 'on', 'on' };
            CurrentTransformation = Transformations{Args{2}};
            updateTransformation(CurrentTransformation);
        else
            TransformationTabs.TabEnables = { 'off', 'off', 'off', 'off', 'off' };
        end
    end
    ...
    function updateTransformation(Transformation)
        switch(Transformation.Type)
            ...
            case 'shearing'
                IgnoreNext = (TransformationTabs.Selection ~= 4);
                TransformationTabs.Selection = 4;
                ShearingX.String = Transformation.X;
                ShearingY.String = Transformation.Y;
                ShearingZ.String = Transformation.Z;
            case 'mirroring'
                IgnoreNext = (TransformationTabs.Selection ~= 5);
                TransformationTabs.Selection = 5;
            otherwise
    ...
    function setTransformation(Type)
        switch CurrentTransformation.Type
            ...
            case 'shearing'
                switch Type
                    case 'x'
                        CurrentTransformation.X = str2double(ShearingX.String);
                    case 'y'
                        CurrentTransformation.Y = str2double(ShearingY.String);
                    case 'z'
                        CurrentTransformation.Z = str2double(ShearingZ.String);
                end
        end
    ...
    function change(Type)
        switch CurrentTransformation.Type
            ...
            case 'shearing'
                Delta = str2double(ShearingDelta.String);
                apply(Type, Delta);
            case 'mirroring'
                CurrentTransformation.MirrorIndex = Type;
        end
        ...
        switch(Type)
            ...
            case 'type'
                ...
                switch TransformationTabs.Selection
                    ...
                    case 4
                        CurrentTransformation = struct('Type', 'shearing', 'X', 0.0, 'Y', 0.0, 'Z', 0.0);
                    case 5
                        CurrentTransformation = struct('Type', 'mirroring', 'MirrorIndex', '');
                    otherwise
